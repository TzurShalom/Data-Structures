...
public class BTree<T extends Comparable<T>> {
    ...
    public void insert(T value)
    {
        ...
        { 
            ...
            root.addKey(value);
        	Object[] array = {root,value,BTreeActionType.SHIFT};
        	deque.push(array); 
        }
        else
        {
            ...
            while (currentNode != null && !wasAdded)
            {
                ...
                {        
                	...
                	int index = currentNode.parent.getValuePosition(medianValue);                	
                    Object[] array = {currentNode,medianValue,BTreeActionType.SPLIT,index};
                    deque.push(array);               	
                ...
                { 
                 	Object[] array = {currentNode,value,BTreeActionType.SHIFT};
                	deque.push(array);  
